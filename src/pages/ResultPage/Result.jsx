...
function Result() {
    ...
    return (
        <section className="px-6 pt-8 w-full flex flex-col gap-10 md:gap-16 xxl:flex-row xxl:gap-[11.5rem] xxl:px-0">
            <h2 className="flex flex-col gap-2 text-dark-slate w-full text-[40px] md:text-heading-large">
            ...
            <article className="flex flex-col gap-3 w-full md:gap-8">
                <div className="p-8 bg-white flex flex-col justify-center items-center gap-4 rounded-xl md:p-12 md:rounded-3xl md:gap-10">
                    ...
                    <div className="flex flex-col gap-4 items-center justify-center">
                        ...
                        <p className="font-regular text-lg text-slate-gray md:text-body-small xxl:text-body-medium">
                            out of 10
                        </p>
                    </div>
                </div>
