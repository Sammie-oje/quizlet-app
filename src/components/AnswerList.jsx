function AnswerList({ answer, letter }) {
    return (
        <li className="flex items-center p-3 rounded-xl bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.15)] text-lg font-medium text-white w-full md:rounded-3xl md:h-20 xxl:px-5 xxl:py-[18px] xxl:h-[92px]">
